  ...
  <div class="container">
      ...
      <?php
         if ( Auth::check() && $group->isVolunteer() ) {
            $info_text = "You can add all of this group's upcoming events to your personal calendar with the <button disabled type='button' class='btn btn-normal-padding btn-sm btn-primary' data-original-title='' title=''><svg width='12' height='12' viewBox='0 0 50 50' version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' xml:space='preserve' xmlns:serif='http://www.serif.com/' style='fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;'>
