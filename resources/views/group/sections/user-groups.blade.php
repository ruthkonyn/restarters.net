<section class="table-section py-30" id="user-groups">
  ...
  <div class="row border-between mt-0 mb-40">
    ...
    <div class="col-12 col-lg-4">
      <p class="mb-0">
        If you can't see any here yet, why not <a href="#tab-B" class="btn-link btn-open-pane">follow your nearest group</a> to hear about their upcoming repair events?
      </p>
    </div>
  </div>
